...
def get_conversational_chain():
    prompt_template = """
    You are an AI assistant providing gift suggestions based on the given context. Respond with detailed and accurate gift recommendations considering the specified age, gender, relationship, occasion, budget, and interests. If specific details are not available in the context, acknowledge it and provide general suggestions based on the given information.
